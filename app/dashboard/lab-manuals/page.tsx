  ...
  return (
    <div className="max-w-3xl">
      ...
      <p className="text-sm text-text-secondary mb-8">
        {items.length} lab manual{items.length !== 1 ? "s" : ""} available.
      </p>

      {items.length === 0 ? (
        <Card><p className="text-sm text-text-secondary">No lab manuals available for your current course and semester yet.</p></Card>
      ) : (
