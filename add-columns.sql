-- Nexus — Schema additions for student redesign
...
-- Add year field to resources and contributions (for PYQ year categorization)
ALTER TABLE public.resources ADD COLUMN IF NOT EXISTS year INTEGER DEFAULT NULL;
ALTER TABLE public.contributions ADD COLUMN IF NOT EXISTS year INTEGER DEFAULT NULL;
